...
// .wrangler/tmp/bundle-mWcamW/checked-fetch.js
...
var chdir = function chdir2(dir4) {
  _cwd = dir4;
};
...
// .wrangler/tmp/pages-aC5nGr/functionsWorker-0.6416279697298686.mjs
...
var __esm = (fn22, res) => function __init() {
...
var init_entry = __esm({
  "../node_modules/unenv/runtime/web/performance/_entry.mjs"() {
    ...
    _PerformanceMark2 = class extends _PerformanceEntry2 {
      entryType = "mark";
    };
    PerformanceMark2 = globalThis.PerformanceMark || _PerformanceMark2;
    _PerformanceMeasure2 = class extends _PerformanceEntry2 {
      entryType = "measure";
    };
    PerformanceMeasure2 = globalThis.PerformanceMeasure || _PerformanceMeasure2;
    _PerformanceResourceTiming2 = class extends _PerformanceEntry2 {
      entryType = "resource";
      serverTiming = [];
      connectEnd = 0;
      connectStart = 0;
...
var init_observer = __esm({
  "../node_modules/unenv/runtime/web/performance/_observer.mjs"() {
    ...
    _PerformanceObserverEntryList2 = class {
      __unenv__ = true;
      getEntries() {
        return [];
      }
...
var init_env = __esm({
  "../node_modules/unenv/runtime/node/process/internal/env.mjs"() {
    ...
    _getEnv2 = (useShim) => _processEnv2 || globalThis.__env__ || (useShim ? _envShim2 : globalThis);
...
var init_process = __esm({
  "../node_modules/unenv/runtime/node/process/internal/process.mjs"() {
    ...
    chdir3 = function chdir22(dir32) {
      _cwd2 = dir32;
    };
    umask3 = function umask22() {
      return 0;
    };
    getegid3 = function getegid22() {
      return 1e3;
    };
    geteuid3 = function geteuid22() {
      return 1e3;
    };
    getgid3 = function getgid22() {
      return 1e3;
    };
    getuid3 = function getuid22() {
      return 1e3;
    };
    getgroups3 = function getgroups22() {
      return [];
    };
    getBuiltinModule3 = (_name) => void 0;
    ...
    hasUncaughtExceptionCaptureCallback2 = () => false;
...
var require_JsonWebTokenError = __commonJS({
  "../node_modules/jsonwebtoken/lib/JsonWebTokenError.js"(exports, module) {
    ...
    init_virtual_unenv_global_polyfill_set_immediate();
    init_virtual_unenv_global_polyfill_clear_immediate();
    var JsonWebTokenError = function(message, error32) {
...
var require_parse = __commonJS({
  "../node_modules/semver/functions/parse.js"(exports, module) {
    ...
    var parse2 = (version22, options, throwErrors = false) => {
      if (version22 instanceof SemVer) {
        return version22;
      }
      try {
...
var require_inc = __commonJS({
  "../node_modules/semver/functions/inc.js"(exports, module) {
    ...
    init_virtual_unenv_global_polyfill_clear_immediate();
    var SemVer = require_semver();
    var inc = (version22, release22, options, identifier, identifierBase) => {
...
var require_prerelease = __commonJS({
  "../node_modules/semver/functions/prerelease.js"(exports, module) {
    ...
    init_virtual_unenv_global_polyfill_clear_immediate();
    var parse2 = require_parse();
    var prerelease = (version22, options) => {
...
var require_range = __commonJS({
  "../node_modules/semver/classes/range.js"(exports, module) {
    ...
    var testSet = (set, version22, options) => {
...
var require_satisfies = __commonJS({
  "../node_modules/semver/functions/satisfies.js"(exports, module) {
    ...
    init_virtual_unenv_global_polyfill_clear_immediate();
    var Range = require_range();
    var satisfies = (version22, range, options) => {
      try {
...
var require_outside = __commonJS({
  "../node_modules/semver/ranges/outside.js"(exports, module) {
    ...
    var lte = require_lte();
    var gte = require_gte();
    var outside = (version22, range, hilo, options) => {
...
var require_gtr = __commonJS({
  "../node_modules/semver/ranges/gtr.js"(exports, module) {
    ...
    var gtr = (version22, range, options) => outside(version22, range, ">", options);
    module.exports = gtr;
  }
});
var require_ltr = __commonJS({
  "../node_modules/semver/ranges/ltr.js"(exports, module) {
    ...
    init_virtual_unenv_global_polyfill_clear_immediate();
    var outside = require_outside();
    var ltr = (version22, range, options) => outside(version22, range, "<", options);
    module.exports = ltr;
  }
});
...
async function onRequestPost(context22) {
  ...
  const jwt3 = await generateAccessToken(json.username, `${context22.env.TOKEN_SECRET}`);
  const res = {
    jwt: jwt3,
    name: json.username
  };
...
async function onRequestPost2(context22) {
  const json = await context22.request.json();
  const jwt3 = await generateAccessToken2(json.username, `${context22.env.TOKEN_SECRET}`);
  const res = {
    jwt: jwt3,
    name: json.username
  };
...
init_virtual_unenv_global_polyfill_set_immediate();
init_virtual_unenv_global_polyfill_clear_immediate();
var drainBody = async (request, env32, _ctx, middlewareCtx) => {
  try {
...
var jsonError = async (request, env32, _ctx, middlewareCtx) => {
  try {
    return await middlewareCtx.next(request, env32);
  } catch (e) {
...
function wrapExportedHandler(worker) {
  ...
  const fetchDispatcher = function(request, env32, ctx) {
...
var drainBody2 = async (request, env4, _ctx, middlewareCtx) => {
  try {
...
var jsonError2 = async (request, env4, _ctx, middlewareCtx) => {
  try {
    return await middlewareCtx.next(request, env4);
  } catch (e) {
...
// .wrangler/tmp/bundle-mWcamW/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-mWcamW/middleware-loader.entry.ts
...
function wrapExportedHandler2(worker) {
  ...
  const fetchDispatcher = function(request, env4, ctx) {
    if (worker.fetch === void 0) {
      throw new Error("Handler does not export a fetch() function.");
    }
...
*/
//# sourceMappingURL=functionsWorker-0.6416279697298686.js.map
